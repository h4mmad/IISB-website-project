 ...
 *
 * Edited by: Mohammed Hammad
 * Includes support for Arabic Language
 *  */
        ...
        function EvoCalendar(element, settings) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    ar: {
                        days: ["الأحد", "الاثنين", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "يوم السبت"],
                        daysShort: ["شهر فبراير", "Mo", "Di", "Mi", "Do", "Fr", "Sa"],
                        daysMin: ["So", "Mo", "شهر فبراير", "Mi", "Do", "Fr", "Sa"],
                        months: ["يناير", "شهر فبراير", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"],
                        monthsShort: ["Jan", "شهر فبراير", "Mär", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"],
                        noEventForToday: "لا يوجد حدث لهذا اليوم .. لذا خذ قسطا من الراحة! :)",
                        noEventForThisDay: "لا يوجد حدث لهذا اليوم .. لذا خذ قسطا من الراحة! :)",
